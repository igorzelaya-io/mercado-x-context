...
import hn.alturaforge.mercadox.context.exception.InvalidEventIdException;
...
public class KafkaIdempotencyAspect {
    ...
    @Around("@annotation(hn.alturaforge.mercadox.context.utils.annotations.KafkaIdempotent)")
